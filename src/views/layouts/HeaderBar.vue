  ...
  <nav class="navbar">
    <div class="col-12">
      ...
      <div class="navbar-header">
        ...
        <a class="navbar-brand" @click="$router.push('/')">Merchifies</a>
      </div>
      ...
      <ul class="nav navbar-nav navbar-right">
        <li class="dropdown"><a href="javascript:void(0);" class="dropdown-toggle xs-hide" data-toggle="dropdown"
        ...
        <li><a @click="$router.push('/logout')" class="mega-menu xs-hide" data-close="true"><i class="zmdi zmdi-power"></i></a></li>
